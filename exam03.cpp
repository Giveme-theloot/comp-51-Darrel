...
// // 0. Hint
// // ================= //
// // 1. Please copy paste this entire content into the following platform for coding exam
...
class Book {
    ...
    string title = " ", author = " ";
    int pages = 0;
    void setDetails(string title = " ", string author = " ", int pages = 0) 
    {
...
public:
    ...
    void addBook() {
        ...
        for (bookCount; bookCount <= MAX_BOOKS; bookCount++)
        {
            bookCount += 1;
        }
    }
...
int main() {
    ...
    int totalPages = 0;
    library.calculateTotalPages();
    cout << "Total Page of all Books: " << totalPages << endl;

    library.displayShelfLayout();
}
